...
<body>
    ...
    <div>
        ...
        <tr><th><asp:Button OnClick="Select_Doctor" runat="server" id="addDrugBtn" name="submit" type="submit"/></th></tr>
         <tr><th> Select Time :</th></tr>
        <tr><th><asp:DropDownList ID="Choose_Time" runat="server" Width="200px">                
        </asp:DropDownList></th></tr>
        </table>
